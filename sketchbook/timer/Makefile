...
.PHONY: all depend includes cleandir
...
# from  top Makefile
  BOOTSTRAPCFLAGS = -O2  -pipe -march=i386 -mtune=pentium4 -pipe

               CC = gcc 
               AS = gcc -c -x assembler -Wa,--noexecstack
...
.SUFFIXES: .cc
    ...
    CXXDEBUGFLAGS = -O2  -pipe -march=i386 -mtune=pentium4 -fno-strict-aliasing -pipe
CXXDEPENDINCLUDES =
 CXXEXTRA_DEFINES =
CXXEXTRA_INCLUDES =
   ...
   COMPRESSMANCMD = gzip -n
        ...
        MANMACROS = -man
         ...
         COLFLAGS = -b
           ...
           MODCPP = cpp
        MODCFLAGS = $(CFLAGS)
            MODAS = gcc -c -x assembler -Wa,--noexecstack
       MODASFLAGS =
  ...
  EXTRA_LIBRARIES =
   ...
   PARALLELMFLAGS =
    ...
    INSTKMEMFLAGS = -m 4711
      ...
      CDEBUGFLAGS = -O2  -pipe -march=i386 -mtune=pentium4 -fno-strict-aliasing -pipe
        CCOPTIONS =
...
SRCS = Dclock.c dclock.c uartman.c
OBJS = Dclock.o dclock.o uartman.o
